...
with open(r"C:\finances\data\sba_loans\_singlebid_under_sat_fullrange.json") as f:
    d = json.load(f)
...
with open(r"C:\finances\data\sba_loans\_drilldown_final_fullrange.json", "w") as f:
    json.dump({
        "rows": table_rows,
